...
**Tweet 4 (feature #3):**
> 📊 Scoring calibrated against two corpora.
>
> 988 public Claude Code setups with substrate (median 32) — apples-to-apples for live scores.
>
> Plus 2,895 standalone CLAUDE.md files (median 18) — the agent-contract baseline.
>
> Most setups have a lot of room to move up.
...
**B (collab angle):**
> Your agent's config is either helping it or quietly confusing it. Dear User audits your CLAUDE.md, hooks, skills, memory — 50+ lint checks, semantic conflict detection, scoring calibrated against 988 public Claude Code setups + 2,895 standalone CLAUDE.md files. Free. dearuser.ai
...
>
> Install: claude mcp add dearuser -- npx @poisedhq/dearuser-mcp
...
> - Scoring calibrated against 988 public Claude Code setups (with substrate) + 2,895 standalone CLAUDE.md files
>
