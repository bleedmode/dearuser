...
export function detectPersona(parsed, scan) {
    const scores = {
        vibe_coder: 0,
        senior_dev: 0,
        indie_hacker: 0,
    ...
    const personaOrder = ['vibe_coder', 'senior_dev', 'indie_hacker', 'venture_studio', 'team_lead'];
...
//# sourceMappingURL=persona-detector.js.map