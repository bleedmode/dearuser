...
- Dependency vulnerabilities in the published `@poisedhq/dearuser-mcp` package

Out of scope: issues in user-supplied CLAUDE.md content, third-party MCP servers, or Claude Code itself.

## Supported versions

We patch the latest published version of `@poisedhq/dearuser-mcp` on npm. Older versions are not backported.
