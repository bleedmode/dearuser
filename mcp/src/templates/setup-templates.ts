...
const COMMON_SKILLS = {
  ...
  dearuser: {
    name: '/dearuser-collab (+ health, security, wrapped, help)',
...
const CODER_TEMPLATE: SetupTemplate = {
  ...
  maintenanceRoutines: [
    ...
    },
    {
      ...
      how: 'Run `/dearuser-health` — review findings, dismiss false positives, fix real ones.',
    },
    {
      ...
      how: 'Run `/dearuser-collab` — compare your score to last run, act on new recommendations.',
    },
  ],
  nextSteps: [
    'Install the Dear User skills — copy skills/ from the repo into ~/.claude/skills/ so /dearuser-collab always works',
...
const OCCASIONAL_TEMPLATE: SetupTemplate = {
  ...
  maintenanceRoutines: [
    ...
    },
    {
      ...
      how: 'Run `/dearuser-collab` — focus on the top recommendation and try it for a week.',
    },
  ],
  nextSteps: [
    'Install the Dear User skills — copy skills/ from the repo into ~/.claude/skills/ so /dearuser-collab always works',
...
const NON_CODER_TEMPLATE: SetupTemplate = {
  ...
  maintenanceRoutines: [
    ...
    },
    {
      ...
      how: 'Run `/dearuser-collab` — try the top suggestion, ignore the rest until next month.',
    },
  ],
  nextSteps: [
    'Install the Dear User skills — copy skills/ from the repo into ~/.claude/skills/ so /dearuser-collab always works',
